 ...
 * @subpackage Patterns_Medical/includes/api
 */
 ...
 */
if ( ! class_exists( 'Patterns_Medical_Api' ) ) {

	/**
	 * Patterns_Medical_Api
	 *
	 * @package Patterns_Medical
	 * @since 1.0.1
	 */
	class Patterns_Medical_Api extends WP_REST_Controller {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'patterns-medical' ), '1.0.0' );
		}
