 ...
 * Slug: patterns-medical/featured-section-4
    ...
    <div class="wp-block-columns alignwide are-vertically-aligned-center">
        ...
        <div class="wp-block-column is-vertically-aligned-center">
            ...
            <div class="wp-block-group has-default-background-color has-background">
                ...
                <div class="wp-block-group alignwide">
                    <!-- wp:heading {"level":5,"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|10"}}} -->
                    <h5 class="wp-block-heading alignwide"><?php esc_html_e( 'David Green', 'patterns-medical' ); ?></h5>
                    <!-- /wp:heading -->
                    ...
                    <p class="has-text-align-left has-tertiary-color has-text-color"
                        style="margin-bottom:0px;line-height:1.8"><?php esc_html_e( 'Dental Assistant', 'patterns-medical' ); ?></p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            </div>
        ...
        <div class="wp-block-column is-vertically-aligned-center">
            ...
            <div class="wp-block-group has-default-background-color has-background">
                ...
                <div class="wp-block-group alignwide"><!-- wp:heading {"level":5,"align":"wide","textColor":"base"} -->
                    <h5 class="wp-block-heading alignwide has-base-color has-text-color"><?php esc_html_e( 'Amy Walker', 'patterns-medical' ); ?></h5>
                    <!-- /wp:heading -->
        ...
        <div class="wp-block-column is-vertically-aligned-center">
            ...
            <div class="wp-block-group has-default-background-color has-background">
                ...
                <!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"constrained"}} -->
                <div class="wp-block-group alignwide"><!-- wp:heading {"level":5,"align":"wide","textColor":"base"} -->
                    <h5 class="wp-block-heading alignwide has-base-color has-text-color"><?php esc_html_e( 'John Miles', 'patterns-medical' ); ?></h5>
                    <!-- /wp:heading -->
